...
namespace Pathfinding.Voxels {
	...
	public partial class Voxelize {
		...
		public void VoxelizeInput (Pathfinding.Util.GraphTransform graphTransform, Bounds graphSpaceBounds) {
			AstarProfiler.StartProfile("BuildUpgrade Navigation Mesh");
		...
		public void BuildCompactField () {
			AstarProfiler.StartProfile("BuildUpgrade Compact Voxel Field");

			//BuildUpgrade compact representation
			...
			AstarProfiler.EndProfile("BuildUpgrade Compact Voxel Field");
		}

		public void BuildVoxelConnections () {
			AstarProfiler.StartProfile("BuildUpgrade Voxel Connections");
			...
			// BuildUpgrade voxel connections
			for (int z = 0, pz = 0; z < wd; z += voxelArea.width, pz++) {
				for (int x = 0; x < voxelArea.width; x++) {
			...
			AstarProfiler.EndProfile("BuildUpgrade Voxel Connections");
		}
		...
		public void BuildDistanceField () {
			AstarProfiler.StartProfile("BuildUpgrade Distance Field");
			...
			AstarProfiler.EndProfile("BuildUpgrade Distance Field");
		}
